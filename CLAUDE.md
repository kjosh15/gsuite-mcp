...
- `src/gsuite_mcp/server.py` — FastMCP server exposing 16 tools (refuses to start without `GSUITE_MCP_API_KEY`)
- `tests/` — pytest suite mirroring the module split (159 tests)
...
Last session: 2026-05-21 00:00:00
