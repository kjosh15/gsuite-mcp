...
- `src/gsuite_mcp/server.py` — FastMCP server exposing 19 tools (refuses to start without `GSUITE_MCP_API_KEY`)
- `tests/` — pytest suite mirroring the module split (292 tests)
...
## Session Tracking
Total Claude sessions: 18
Last session: 2026-06-04 21:00:04
